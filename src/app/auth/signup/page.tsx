...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    gsap.to(containerRef.current, {
      ...
      scale: 0.95,
      duration: 0.4,
      onComplete: () => router.push("/onboarding/personal-details"),
    });
  };
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle, #C2E03A 0%, transparent 70%)",
        }}
      />
      ...
      >
        ...
        <p className="text-[#555] text-[12px] text-center leading-relaxed">
          ...
          <span className="text-[#C2E03A]">Terms of Service</span> and{" "}
          <span className="text-[#C2E03A]">Privacy Policy</span>
        </p>
